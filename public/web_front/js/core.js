...
ashade.init = function () {
  ...
  jQuery(".ashade-back").on("click", function (e) {
    ...
    if ($this.hasClass("is-home-return")) {
      ...
      gsap.to(".ashade-home-link--rental", 0.5, {
        css: {
          top: "75%",
        },
        delay: 1,
        onComplete: function () {
          jQuery(".ashade-home-link--rental")
            .addClass("is-loaded")
            .removeClass("is-inactive");
        },
      });
...
ashade.loading = function () {
  ...
  if ($ashade_body.hasClass("ashade-home-template")) {
    ...
    gsap.to(".ashade-home-link--rental:not(.is-inactive)", 0.5, {
      css: {
        top: "100%",
      },
      onComplete: function () {
        jQuery(".ashade-home-link--rental:not(.is-inactive)").addClass(
          "is-loaded"
        );
      },
    });
...
ashade.change_location = function (this_href) {
  ...
  if ($ashade_body.hasClass("ashade-home-template")) {
    ...
    setTimeout(
      "jQuery('.ashade-home-link--rental:not(.is-inactive)').removeClass('is-loaded')",
      links_timeout
    );
    gsap.to(".ashade-home-link--rental:not(.is-inactive)", 0.5, {
      css: {
