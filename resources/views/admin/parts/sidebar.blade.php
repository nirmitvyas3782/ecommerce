     ...
     <div data-simplebar class="h-100">
         ...
         <div id="sidebar-menu">
             ...
             <ul class="metismenu list-unstyled" id="side-menu">
                 ...
                 <li>
                     <a href="{{ route('dashboard.index') }}"><i class="feather-home"></i><span
                             class="badge badge-pill badge-success float-right">1</span><span>Dashboard</span></a>
                 </li>

                 <li class="menu-title">Content</li>

                 <li>
                     <a href="{{ route('image_gallary.index') }}"><i class="feather-image"></i><span>Image
                             Gallary</span></a>
                 </li>
                 <li>
                 ...
                 <li>
                     <a href="{{ route('order.index') }}"><i class="feather-shopping-bag"></i><span>Orders</span></a>
                 </li>
                 <li>
                 ...
                 <li>
                     <a href="{{ route('auth.logout') }}"><i class="feather-log-out"></i><span>Log Out</span></a>
                 </li>
             </ul>
         </div>
         <!-- Sidebar -->
