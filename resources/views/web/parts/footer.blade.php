                    ...
                    <div class="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0 wow animate__animated animate__fadeInUp"
                        ...
                        <ul class="contact-infor">
                          <h4 class="widget-title">Contact</h4>
                            ...
                            <li>
                                <img src="/web/imgs/theme/icons/icon-contact.svg" alt="" /><strong>Call
                                    Us:</strong><span>(+91) - 540-025-124553</span>
                            </li>
                            <li>
                                <img src="/web/imgs/theme/icons/icon-email-2.svg"
                                    alt="" /><strong>Email:</strong><span>sale@Nest.com</span>
                            </li>
                            <li>
                                <img src="/web/imgs/theme/icons/icon-clock.svg"
                ...
                <div class="footer-link-widget widget-install-app col wow animate__animated animate__fadeInUp"
                    ...
                    <div class="download-app">
                        <a href="#" class="hover-up mb-sm-2 mb-lg-0"><img class="active"
                                src="/web/imgs/theme/app-store.jpg" alt="" /></a>
                        <a href="#" class="hover-up mb-sm-2"><img src="/web/imgs/theme/google-play.jpg"
                                alt="" /></a>
                    </div>
                </div>
            </div>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
                <p class="font-sm mb-0">
                    &copy; 2024, <strong class="text-brand">Deedy</strong> - Supplier's Portal
                </p>
            </div>
            <div class="col-xl-4 col-lg-6 text-center d-none d-xl-block">
                <div class="hotline d-lg-inline-flex mr-30">
                    <img src="/web/imgs/theme/icons/phone-call.svg" alt="hotline" />
